...
public class Graph {
    ...
    public Graph(int cap){
        ...
        LinkedList<Integer>[] arr = new LinkedList[cap];
        adjacencyList = arr;
    }
...
//            cap *= 2;
    ...
    public void Explore(Vertex v){
        ...
        for(int i=0 ; i<adjacencyList[v.intKey].size() ; i++){
            ...
            if(!vertexList[adjacencyList[v.intKey].get(i)/*adjacency vertex index*/].visited){
                Explore(vertexList[adjacencyList[v.intKey].get(i)]);
            }
        }
    }
